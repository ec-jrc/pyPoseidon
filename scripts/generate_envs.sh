...
./scripts/merge_environment_yaml.py ./dependencies/python3.12.yml  ./dependencies/binary.yml > ./environments/binary-p3.12.yml
...
./scripts/merge_environment_yaml.py ./dependencies/python3.12.yml ./dependencies/binary.yml ./dependencies/main.yml > ./environments/base-p3.12.yml
...
./scripts/merge_environment_yaml.py ./dependencies/python3.12.yml ./dependencies/binary.yml ./dependencies/main.yml ./dependencies/viz.yml > ./environments/viz-p3.12.yml
...
./scripts/merge_environment_yaml.py ./dependencies/python3.12.yml ./dependencies/binary.yml ./dependencies/dev.yml ./dependencies/docs.yml ./dependencies/main.yml ./dependencies/viz.yml > ./environments/full-p3.12.yml
