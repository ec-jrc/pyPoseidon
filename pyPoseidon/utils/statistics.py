...
def vtable(obsrv,model):
    ...
    dic = {'Mean Absolute Error':mse, 'RMSE': rmse, 'Scatter Index' : scInd, 'percentage RMSE' : percrmse, 'BIAS or mean error' : bias,
     'Standard deviation of residuals' : sdr, 'Correlation Coefficient': corcoef, 'R^2': corcoefSq, 'Nash-Sutcliffe Coefficient': nsccoef, 'lamda index':lamda_index }
